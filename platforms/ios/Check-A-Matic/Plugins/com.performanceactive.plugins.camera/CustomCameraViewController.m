...
- (UIView*)createOverlay {
   ...
   // [_captureButton setImage:[UIImage imageNamed:@"www/img/cameraoverlay/capture_button_pressed.png"] forState:UIControlStateHighlighted];
    ...
    [_backButton setBackgroundImage:[UIImage imageNamed:@"www/img/cameraoverlay/quit256.png"] forState:UIControlStateNormal];
    [_backButton setBackgroundImage:[UIImage imageNamed:@"www/img/cameraoverlay/quit256.png"] forState:UIControlStateHighlighted];
   ...
   // [[_backButton titleLabel] setFont:[UIFont systemFontOfSize:18]];
    ...
    [_sendButton setImage:[UIImage imageNamed:@"www/img/cameraoverlay/send256.png"] forState:UIControlStateNormal];
    [_sendButton setImage:[UIImage imageNamed:@"www/img/cameraoverlay/send256.png"] forState:UIControlStateSelected];
    [_sendButton setImage:[UIImage imageNamed:@"www/img/cameraoverlay/send256.png"] forState:UIControlStateHighlighted];
